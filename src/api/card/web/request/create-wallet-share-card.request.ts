...
export class CreateWalletShareCardRequest {
  constructor(partial: Partial<CreateWalletShareCardRequest>) {
  ...
  public readonly typeOfCardEnum?: string[] = [TypeOfCardEnum.WALLET_SHARE];
